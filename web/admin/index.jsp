      ...
      <div class="row">
        ...
        <div class="col-lg-9 mb-4">
            ...
            <%
               ...
               if(rs.next()){
                   %>
                   <h2 style="text-transform: uppercase;font-weight: bold;" class="text-primary"><%=rs.getString("soc_name")%></h2>
                   <p style="text-transform: uppercase;font-size: 15px;font-weight: bold;" class="text-success">
                       Address:<br>
                       <%=rs.getString("soc_address")%><br>
                       Contact: <%=rs.getString("soc_contact")%><br>
                       Email: <%=rs.getString("soc_email")%>
