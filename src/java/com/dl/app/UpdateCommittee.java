...
public class UpdateCommittee extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            DAL d=new DAL();
           int sc_code=Integer.parseInt(request.getParameter("sc_code"));
           ...
           String sql="update soc_committee set sc_dof = '"+sc_dof+"', soc_chairman= "+soc_chairman+",soc_secretary = "+soc_secretary+",soc_treasurer = "+soc_treasurer+" where sc_code = "+sc_code;
